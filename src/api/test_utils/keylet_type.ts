...
enum LedgerSpecificFlags {
  ...
  lsfDisallowIncomingNFTokenOffer = 0x04000000, // True, reject new incoming NFT offers
  lsfDisallowIncomingCheck = 0x08000000, // True, reject new checks
  lsfDisallowIncomingPayChan = 0x10000000, // True, reject new paychans
  lsfDisallowIncomingTrustline = 0x20000000, // True, reject new trustlines (only if no issued assets)
